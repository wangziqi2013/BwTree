...
./build/skiplist.o:
	$(CXX) ./benchmark/skiplist/skiplist.cpp -c -o ./build/skiplist.o $(CXX_FLAG) $(OPT_FLAG) $(GMON_FLAG)
...
./build/benchmark_skiplist_full.o: ./test/benchmark_bwtree_full.cpp ./src/bwtree.h
	$(CXX) ./test/benchmark_skiplist_full.cpp -c -o ./build/benchmark_skiplist_full.o $(CXX_FLAG) $(OPT_FLAG) $(GMON_FLAG)
...
benchmark-skiplist-full: main
	$(PRELOAD_LIB) ./main --benchmark-skiplist-full
