...
/*
 * benchmark_skiplist_full.cpp - This file contains test suites for command
 *                               benchmark-skiplist-full
 */

#include "test_suite.h"

/*
 * BenchmarkSkipListRandInsert() - As name suggests
 */
...
/*
 * BenchmarkSkipListSeqInsert() - As name suggests
 */
void BenchmarkSkipListSeqInsert(SkipListType *t, 
                                int key_num, 
                                int thread_num) {
...
/*
 * BenchmarkSkipListSeqRead() - As name suggests
 */
void BenchmarkSkipListSeqRead(SkipListType *t, 
                              int key_num,
                              int thread_num) {
  const int num_thread = thread_num;
  int iter = 1;
...
/*
 * BenchmarkSkipListRandRead() - As name suggests
 */
void BenchmarkSkipListRandRead(SkipListType *t, 
                               int key_num,
                               int thread_num) {
  const int num_thread = thread_num;
  int iter = 1;
...
/*
 * BenchmarkSkipListZipfRead() - As name suggests
 */
void BenchmarkSkipListZipfRead(SkipListType *t, 
                               int key_num,
                               int thread_num) {
  const int num_thread = thread_num;
  int iter = 1;
