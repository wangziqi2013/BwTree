# BwTree
This is a street strength implementation of Bw-Tree which is currently deployed in SQL Server Hekaton, Azure DocumentDB, Bing and other Microsoft products.
